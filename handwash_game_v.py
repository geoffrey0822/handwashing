...
class ResultWidget2(QtGui.QWidget):
    def __init__(self,parent=None):
        ...
        self.topList.setGeometry(50,50,1240,200)
    ...
    def update(self):
        ...
        self.topList.setRowHeight(0,180)
        self.topList.setRowHeight(1,50)
        self.topList.setColumnCount(0)
        
        self.bottomList.setRowCount(1)
        self.bottomList.setRowHeight(0,180)
...
class ResultContainer(QtGui.QWidget):
    def __init__(self,parent=None):
        ...
        self.btnTrain.setGeometry(screen_width-200,40,180,180)
...
class Game2GUI(QtGui.QWidget):
    def __init__(self,parent=None):
        ...
        self.lblHeader.setGeometry(screen_width/2-200,50,300,100)
...
class Game3GUI(QtGui.QWidget):
    def __init__(self,parent=None):
        ...
        self.leftPanel.setGeometry(0,ptop,pwidth,pheight)
        self.rightPanel=ImageWidget('',self)
        self.rightPanel.sWidth=pwidth
        self.rightPanel.sHeight=pwidth
        self.rightPanel.setGeometry(pwidth,ptop,pwidth,pheight)
    ...
    def nextPose(self):
        global all_poses,passed_poses,train_currentPose,uiUpdated
...
def realtime(w=[]):
    global classifier,sub_classifier,ix,iy,ex,ey,frame,roi,lock,bufferImg,bufferSize,game_pose_roi,box_startAt,gui,game_thread,rawroi,rawframe,previousPredict,pmode,global_start,global_end,global_count,resultGUI,tex,tey,camID,gui2,gui3,all_pose_durations,uiUpdated,modeChanged
...
def realtime2(w=[]):
    global classifier,sub_classifier,ix,iy,ex,ey,frame,roi,lock,bufferImg,bufferSize,game_pose_roi,box_startAt,gui,container,gui2,pmode,realtimeView,screen_width,screen_height,resultGUI,gui3
